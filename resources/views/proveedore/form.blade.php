<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('nombre_representante') }}
            {{ Form::text('nombre_representante', $proveedore->nombre_representante, ['class' => 'form-control' . ($errors->has('nombre_representante') ? ' is-invalid' : ''), 'placeholder' => 'Nombre Representante']) }}
